...
**929 публікацій · 131 домен · 33 міста · 45 календарних днів.** Одиниця спостереження — публікація × місто. Для кожного запису збережено оригінальний заголовок, конкретний URL, дату, дослівну цитату з тіла сторінки, категорію розміру, статус, провенанс і зріз збору.
...
- 115 нових рядків мають `run = 1 Sep`; старі зрізи збережені.
